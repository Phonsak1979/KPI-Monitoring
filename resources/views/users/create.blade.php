    ...
    <div class="container-fluid p-3">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header d-flex bg-gradient-success">
                        <h3 class="card-title"><i class="fas fa-user-plus mr-2"></i><b>เพิ่มผู้ใช้งาน</b></h3>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                    value="{{ old('name') }}" placeholder="เช่น นายสมชาย ใจดี">
                                @error('name')
                            ...
                            <div class="form-group">
                                <label for="email">E-mail (สำหรับเข้าสู่ระบบ) <span class="text-danger">*</span></label>
                            ...
                            <div class="form-group">
                                <label for="status">สถานะ <span class="text-danger">*</span></label>
                                    <select name="status" id="status" class="custom-select">
                                        <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>ใช้งานปกติ
                                            (Active)</option>
                                        <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>
                                            ระงับการใช้งาน (Inactive)</option>
                                    </select>
                                    @error('status')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
