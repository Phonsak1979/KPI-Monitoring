                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="custom-select" disabled>
                                    <option value="active" {{ $user->status == 'active' ? 'selected' : '' }}>ปกติ (Active)</option>
                                    <option value="inactive" {{ $user->status == 'inactive' ? 'selected' : '' }}>ระงับการใช้งาน (Inactive)</option>
                                </select>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-success"><i class="fas fa-save"></i> บันทึก</button>
                            <a href="{{ route('dashboard') }}" class="btn btn-warning"><i class="fas fa-undo-alt"></i> กลับ</a>
                        </div>
                    </form>
